...
public class Trip
    ...
    /**
     * Amount subtracted from genel toplam before KDV is stripped for the prim
     * hakediş matrahı on the ÖN sheet
     * ({@code B26 = (B25 - SUM(C17:C24)) / 1.2}). Written to C17, the nakit
     * row of the "PİRİMDEN DÜŞÜLECEK TAHSİLAT" column.
     */
